import type { WorkflowPhase, AgentFamily, TemplateRegistry } from './types';
import { LightbulbIcon, ClipboardListIcon, WrenchIcon, CodeIcon } from './components/icons';

export const WORKFLOW_PHASES: WorkflowPhase[] = [
  {
    phase: 1,
    title: 'Discovery & Definition',
    goal: 'Clearly articulate what problem the software solves and who it serves.',
    activities: [
      { name: 'Define project goals', priority: 'High' },
      { name: 'Identify target audience', priority: 'High' },
      { name: 'List core functional requirements', priority: 'High' },
      { name: 'List non-functional requirements', priority: 'Medium' },
      { name: 'Define initial MVP scope', priority: 'High' },
    ],
    icon: LightbulbIcon,
    color: 'blue',
  },
  {
    phase: 2,
    title: 'Planning & High-Level Design',
    goal: 'Determine how we will build the defined solution.',
    activities: [
      { name: 'Select technology stack', priority: 'High' },
      { name: 'Outline system architecture', priority: 'High' },
      { name: 'Create a high-level project roadmap', priority: 'Medium' },
      { name: 'Estimate resources and team structure', priority: 'Medium' },
    ],
  ...
  },
  {
    ...
    goal: 'Prepare the necessary infrastructure for development and collaboration.',
    activities: [
      { name: 'Set up Git code repositories', priority: 'High' },
      { name: 'Establish basic CI/CD pipelines', priority: 'Medium' },
      { name: 'Configure development environments', priority: 'High' },
      { name: 'Choose project management tools', priority: 'Low' },
      { name: 'Establish team communication channels', priority: 'Low' },
    ],
    icon: WrenchIcon,
    color: 'green',
  },
  {
    ...
    goal: 'Begin building the core structure and establish quality practices early.',
    activities: [
      { name: 'Implement initial project structure', priority: 'High' },
      { name: 'Build basic UI components', priority: 'High' },
      { name: 'Define and implement unit testing strategy', priority: 'Medium' },
      { name: 'Define and implement integration testing strategy', priority: 'Medium' },
    ],
    icon: CodeIcon,
    color: 'yellow',
  },
...
export const AGENT_FAMILY: AgentFamily = {
