...
export const WORKFLOW_PHASES: WorkflowPhase[] = [
  {
    ...
    activities: [
      ...
      { name: 'List core functional requirements' },
      { name: 'List non-functional requirements' },
      { name: 'Define initial MVP scope' },
    ],
    icon: LightbulbIcon,
    color: 'blue',
  },
  {
    ...
    activities: [
      ...
      { name: 'Outline system architecture' },
      { name: 'Create a high-level project roadmap' },
      { name: 'Estimate resources and team structure' },
    ],
  ...
  },
  {
    ...
    activities: [
      { name: 'Set up Git code repositories' },
      { name: 'Establish basic CI/CD pipelines' },
      { name: 'Configure development environments' },
      { name: 'Choose project management tools' },
      { name: 'Establish team communication channels' },
    ],
    icon: WrenchIcon,
    color: 'green',
  },
  {
    ...
    activities: [
      { name: 'Implement initial project structure' },
      { name: 'Build basic UI components' },
      { name: 'Define and implement unit testing strategy' },
      { name: 'Define and implement integration testing strategy' },
    ],
    icon: CodeIcon,
    color: 'yellow',
  },
